...
const Card = ({ name, img, pdfLink, semester }) => {
  return (
    <div className="border border-gray-300  p-5 rounded-xl shadow hover:shadow-lg transition-shadow">
      ...
      <p className="text-sm sm:text-base text-gray-600 mb-4">
        Unit-wise notes for <b className="text-red-900">Semester {semester}</b>.
        <br />
        Includes key topics and easy-to-understand summaries.
      </p>
